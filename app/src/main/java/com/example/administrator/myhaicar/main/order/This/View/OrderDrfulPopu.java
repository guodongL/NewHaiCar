...
public class OrderDrfulPopu extends PopupWindow {
    private Context mContext;
    private OnDialogClickListener dialogClickListener;
    private ImageView image;
    private TextView titleTv;
    private String title;
    public OrderDrfulPopu( Context mContext,String title){
        super(mContext);
        this.title=title;
    ...
    private void initalize() {
        ...
        View view = inflater.inflate(R.layout.order_defulpopu, null);
        setContentView(view);
