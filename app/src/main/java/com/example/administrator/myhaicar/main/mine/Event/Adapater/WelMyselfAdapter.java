...
public class WelMyselfAdapter extends BaseAdapter {
    private Context mContext;
    private LayoutInflater mInflater;
    private List<MyWelfBean.ActiInfoBean> list;
    private static final int TYPE1 = 0, TYPE2 = 1;
    public WelMyselfAdapter(Context mContext,List<MyWelfBean.ActiInfoBean> list){
  ...
  /*  @Override
    ...
    public void reloadGridView(List<MyWelfBean.ActiInfoBean> _list, boolean isClear) {
        if (isClear) {
            list.clear();
        }
        list.addAll(_list);
