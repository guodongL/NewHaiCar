...
public class CarColorsTwoFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        arrColors=getResources().getStringArray(R.array.arrColors2);
        arrDrawable=new Drawable[arrColors.length];
        if (skin){
            typedArray=getResources().obtainTypedArray(R.array.arrCarcolors2night);
        }else {
            typedArray=getResources().obtainTypedArray(R.array.arrCarcolors2day);
        }
