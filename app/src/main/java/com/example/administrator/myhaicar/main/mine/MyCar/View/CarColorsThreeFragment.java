...
public class CarColorsThreeFragment extends Fragment {
    ...
    private CarColorsFirstFragment.MyListener mListener;
    ...
    public void onAttach(Activity context) {
        ...
        try {
            mListener = (CarColorsFirstFragment.MyListener) context;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        arrColors=getResources().getStringArray(R.array.arrColors3);
        arrDrawable=new Drawable[arrColors.length];
        if (skin){
            typedArray=getResources().obtainTypedArray(R.array.arrCarcolors3night);
        }else {
            typedArray=getResources().obtainTypedArray(R.array.arrCarcolors3day);
        }
